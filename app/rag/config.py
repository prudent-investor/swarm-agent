...
DEFAULT_SOURCES_DIR = DEFAULT_DATA_BASE / "sources"
DEFAULT_RAW_DIR = DEFAULT_DATA_BASE / "raw"
DEFAULT_CHUNKS_DIR = DEFAULT_DATA_BASE / "chunks"
DEFAULT_INDEX_DIR = DEFAULT_DATA_BASE / "index"
DEFAULT_SEED_FILE = DEFAULT_SOURCES_DIR / "seed_urls.txt"
DEFAULT_WHITELIST_FILE = DEFAULT_SOURCES_DIR / "whitelist.txt"


def create_paths(
    base: Path = DEFAULT_DATA_BASE,
